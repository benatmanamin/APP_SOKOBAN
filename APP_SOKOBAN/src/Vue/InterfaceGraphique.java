...
public class InterfaceGraphique implements Runnable, InterfaceUtilisateur {
	...
	public static void demarrer(Jeu j, CollecteurEvenements c) {
		...
		try {
			SwingUtilities.invokeAndWait(vue);
		} catch (InterruptedException e) {
			Thread.currentThread().interrupt();
			throw new RuntimeException("Demarrage graphique interrompu", e);
			...
			throw new RuntimeException("Impossible de demarrer l'interface graphique", cause);
		}
	}
